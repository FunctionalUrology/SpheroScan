...
# Installation
  - #### Download sourcecode and model weights. 
    ...
    2. Download the model weights (weights.zip) from https://zenodo.org/record/7552508#.Y8mkq-zMKsA and move/copy them to the previously downloaded SpheroScan directory.
